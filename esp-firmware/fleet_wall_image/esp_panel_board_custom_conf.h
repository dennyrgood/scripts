 ...
 */
    ...
    // fleet_wall_image_spike only: 16MHz -> 14MHz, testing whether a lower
    // pixel clock (less PSRAM bandwidth demanded by the display) stops the
    // intermittent flicker episodes. Waveshare's stock value is 16MHz.
