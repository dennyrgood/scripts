...
# Last updated: 2026-06-15 17:29 UTC
...
while ($true) {
    ...
    try {
        ...
        (Get-Date).ToUniversalTime().ToString("yyyy-MM-ddTHH:mm:ss.ffffff+00:00") | Set-Content -Path $heartbeatFile -Encoding UTF8 -NoNewline
