...
# Use backup-models-bare-to-nas-smb.ps1 instead.
#
# One-time backup: OneDrive Models_bare (ib) -> FleetNAS /volume1/models_backup/Models_bare
# Priority 2 (lower priority: already live-shared to tb and cwh separately).
#
# Usage:
#   ./backup-models-bare-to-nas.sh        # dry run (lists what would be copied, copies nothing)
#   ./backup-models-bare-to-nas.sh go     # actually performs the copy
#
...
SRC="/cygdrive/c/Users/Pc/OneDrive/DropBoxReplacement/MathesDropBox/0ComfyUI/Models_bare/"
DEST="dhm@192.168.178.123:/volume1/misc/models_backup/Models_bare/"
